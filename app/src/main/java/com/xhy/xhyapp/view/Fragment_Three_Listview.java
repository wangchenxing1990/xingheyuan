 ...
 */
public class Fragment_Three_Listview extends ListView{
    ...
    public Fragment_Three_Listview(Context context) {
        this(context, null);
    }

    public Fragment_Three_Listview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public Fragment_Three_Listview(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRightViewWidth = (int) mTypedArray.getDimension(
                R.styleable.swipelistviewstyle_right_width, 135*bi);
        mTypedArray.recycle();
    }
