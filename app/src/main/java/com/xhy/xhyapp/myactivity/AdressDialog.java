...
public class AdressDialog {
    ...
    public AdressDialog builder() {
        ...
        propicker.setDisplayedValues(mycity.getCity("0_19"));
        propicker.setMinValue(0);
        propicker.setMaxValue(mycity.getCity("0_19").length - 1);
        ...
        townpicker.setDisplayedValues(mycity.getCity("0_19_1"));
        townpicker.setMinValue(0);
        townpicker.setMaxValue(mycity.getCity("0_19_1").length - 1);
    ...
    public AdressDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public AdressDialog setCanceledOnTouchOutside(boolean cancel) {
